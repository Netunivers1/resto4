...
var DesertComponent = /** @class */ (function () {
    ...
    */
    DesertComponent.prototype.pagination = function (page_param, limits) {
        ...
        if (is_paginate_allowed) {
            this.dessertsCharger = false;
            this.http.get(__WEBPACK_IMPORTED_MODULE_3__config_host__["a" /* urlApi */] + '/menu/1/' + page_param + "/" + limits)
                .map(function (response) { return response.json(); })
                .subscribe(function (data) {
...
var PlatdujourComponent = /** @class */ (function () {
     ...
     * @return void
    */
    PlatdujourComponent.prototype.pagination = function (page_param, limits) {
        var _this = this;
        if (limits === void 0) { limits = 0; }
        var is_paginate_allowed = true;
        if (page_param == this.page_current && limits == 0)
        ...
        if (is_paginate_allowed) {
            this.loading = true;
            this.http.get(__WEBPACK_IMPORTED_MODULE_2__config_host__["a" /* urlApi */] + '/platdujour/1/' + page_param + "/" + limits)
                .map(function (response) { return response.json(); })
                .subscribe(function (data) {
                _this.listProduct = data.contain;
                _this.loading = false;
                _this.p_prev = data.p_prev;
                _this.p_next = data.p_next;
                _this.page_current = data.p_current;
...
var VinsComponent = /** @class */ (function () {
     ...
     * @return void
    */
    VinsComponent.prototype.pagination = function (page_param, limits) {
        var _this = this;
        if (limits === void 0) { limits = 0; }
        var is_paginate_allowed = true;
        if (page_param == this.page_current && limits == 0)
        ...
        if (is_paginate_allowed) {
            this.loading = true;
            this.http.get(__WEBPACK_IMPORTED_MODULE_3__config_host__["a" /* urlApi */] + '/vins/1/' + page_param + "/" + limits)
                .map(function (response) { return response.json(); })
                .subscribe(function (data) {
                _this.listProduct = data.contain;
                _this.loading = false;
